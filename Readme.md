...
5. 28/01 – **updated!** Libraries (static). Inheritance: Pure virtual functions (Creating interface objects). Function objects. STL Library: erase(), algorithms. Also: switch, isnan, isinf. Revisiting header and source files. [Code14](lecture5_code%202.zip) [Slides5](Lecture5b.zip) [Slides_SummaryReview](Lecture5-SummaryReview.zip) [Slides_ExtensiveSummary](Lecture5-ExtensiveSummary.zip) (Adriana Paluszny)
