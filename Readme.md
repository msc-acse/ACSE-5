...
4. 24/01 – Object oriented programming (creating objects). Copy constructor, members, operators, mutators, accessors. **MSVC Debugger (moved)**. Introduction to Inheritance, Polymorphism & Encapsulation in C++. (Adriana Paluszny)  
