...
5. 28/01 – **updated!** Libraries (static). Inheritance, Part II. Pure virtual functions (Creating interface objects). STL Library, Part II. erase(), function objects, algorithms. Also: switch, isnan, isinf. Revisiting header and source files. (Adriana Paluszny)
